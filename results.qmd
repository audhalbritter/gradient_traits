...
Site-level mean latitude (plot coordinates averaged within each site) versus downscaled mean annual temperature at 2 m (T2m), using the same climate extract as in the analyses. Points are coloured by region.
...
#| message: false
#| fig-height: 4
#| fig-cap: "Downscaled mean annual temperature at 2 m versus site latitude. Each point is one site; colours match regions used in diversity and trait figures."
