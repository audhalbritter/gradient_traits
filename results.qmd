...
This figure shows diversity indices (richness, Shannon diversity, and evenness) across mean annual temperature. The solid grey line represents the marginal prediction from mixed-effects models, while points are colored by region.
...
This ridgeline plot shows the distribution of each trait along the elevation gradient, separated by region. This helps visualize how the range and density of trait values shift across different alpine environments.
