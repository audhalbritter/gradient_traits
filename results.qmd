...
This figure shows trait variance in relation to growing season temperature (CHELSA). The solid grey line represents the marginal prediction from mixed-effects models, while points are colored by region.

```{r}
#| label: fig-trait-variance-gst
#| echo: false
#| warnings: false
#| fig-height: 6

tar_load(trait_variance_gst_fig)
trait_variance_gst_fig
